...
//    public static let shared = ASMusicAPI()
    ...
    /// - Returns: Music의 배열
    public static func auth() async {
        _ = await MusicAuthorization.request()
    }

    public static func search(for text: String, _ maxCount: Int = 10, _ offset: Int = 0) async throws -> [Music] {
    ...
    public static func randomSong(from playlistId: String) async throws -> ASEntity.Music {
